...
class UserInputField(UserControl):
    ...
    def prefix_email_containers(self):
        email_labels = ["@gmail.com", "@mail.ru"]
    ...
    def get_prefix_emails(self, e):
        if self.function_emails:
            email = self.controls[0].content.controls[1].value
            if e.data:
                if "@gmail.com" in email or "@mail.ru" in email:
    ...
    def get_green_check(self, e):
        if self.function_check:
            ...
            if email:
                if "@gmail.com" in email or "@mail.ru" in email or password:
                    time.sleep(0.5)
                ...
                content=Column(
                    ...
                    controls=[
                        ...
                        Column(
                            ...
                            spacing=5,
                            controls=[
                                Text("Вход в учетную запись", size=22, weight="bold"),
                                Text(
                                    "",
                                    size=13,
                                    weight="bold",
                        ...
                        Row(
                            ...
                            controls=[
                                Container(
                                    content=Text("Забыли пароль?", size=9),
                                )
                            ],
                        ),
